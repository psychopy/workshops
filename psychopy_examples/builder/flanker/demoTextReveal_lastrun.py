...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.01),
    on Sun Jan 21 14:41:16 2018
...
expName = 'demoTextReveal'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/lpzjwp/Dropbox/workshops/working_demos/builder/flanker/demoTextReveal.psyexp',
...
sentence = visual.TextStim(win=win, name='sentence',
    text='A long line of text to appear very gradually',
    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=2, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
mask = visual.Rect(
    win=win, name='mask',units='norm', 
