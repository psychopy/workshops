...
html_title = "{} {}".format(project, year)
...
# of the sidebar.
html_logo = '_static/nott_logo.png'
...
htmlhelp_basename = '{}_{}doc'.format(project, year)
...
latex_documents = [
  ('index', '%s.tex' %filebase, project,
   u'The PsychoPy team', 'manual'),
]
...
man_pages = [
    ('index', filebase, project,
     [u'The PsychoPy team'], 1)
]
...
texinfo_documents = [
  ('index', filebase, u'{} {} Documentation'.format(project, year),
   u'The PsychoPy team', filebase, 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = project
epub_author = u'The PsychoPy team'
epub_publisher = u'The PsychoPy team'
epub_copyright = u'%s, The PsychoPy team' %year

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'PEP2 %s'  %year
...
intersphinx_mapping = {'python':('https://docs.python.org/2/', None),
                       ...
                       'scipy':('http://docs.scipy.org/doc/scipy-0.13.0/reference/', None),
