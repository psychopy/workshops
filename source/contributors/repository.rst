...
To check that worked you should open python in the terminal and try to import psychopy and see if it's the version you expected::
    ...
    2021.1.0
    >>> psychopy
    <module 'psychopy' from '/path/to/local/git/folder/psychopy/__init__.py'>
...
To fix a bug in code that has already been released, checkout the `release` trunk, create and checkout a new branch, then commit and push to your repo::

    $ git checkout release
    $ git pull upstream release
    $ git checkout -b hotfix-whatAreYouFixing
         <do coding here and commits here>
    $ git push origin hotfix-whatAreYouFixing
