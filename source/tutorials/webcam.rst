...
From Builder
------------
If you would like to collect responses using webcam, we now have a `camera component <https://www.psychopy.org/builder/components/camera.html>`_ which can also be used for online studies.
