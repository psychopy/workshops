:orphan:
:header_template: workshops_header.html
:title: Home
...
.. grid:: 1 1 1 1
    ...
    .. grid-item-card:: :octicon:`info` News
        :link: https://run.pavlovia.org/pavlovia/survey/?surveyId=bcaab3c1-fc72-479a-9b82-226c84a64fb3
...
Note: This is not a workshop designed to teach you about PsychoPy or Pavlovia, the focus is on GitHub basics.
...
.. grid:: 1 1 2 2
    ...
    .. grid-item::
      ...
      * Learn PsychoPy and/or Pavlovia, and leave with your experiment!
      ...
      .. button-link:: https://forms.clickup.com/4570406/f/4bf96-7492/23BIUWV171YCYIEPPI
                :color: primary
    ...
    .. grid-item::
        ...
        .. image:: _static/3.png
            :width: 420
            :alt: Cartoon of a teacher teaching PsychoPy
            :align: right
...
.. grid:: 1 1 2 2
    ...
    .. grid-item::
        ...
        .. image:: _static/LJM_2022.jpg
            :width: 650
            :alt: One of our science officers teaching a workshop
    ...
    .. grid-item::
      ...
      * Content tailored to Undergraduate, Postgraduate or Research Staff level.
      ...
      .. button-link:: https://forms.clickup.com/4570406/f/4bf96-7472/SGW2NTZRH1QNASNGW8
                :color: primary
  ...
  .. grid-item-card:: Creating perception studies to run in lab and online using PsychoPy and Pavlovia.
    :link: https://drive.google.com/drive/folders/1Fq9FM7vYD8pqKh129g2RWx7PEnqFP9m5?usp=drive_link
      ...
      *Presented at: European Conference on Visual Perception, ECVP, 2024*
      ...
      :bdg:`Staircases` :bdg:`Psychophysics online`
  
  .. grid-item-card:: A Beginners guide to extracting PsychoPy data using python.
    :link: https://drive.google.com/drive/folders/1uTdWqlmVGYrVqZPau74cfEk832nQRLwJ?usp=drive_link
      
      *Presented at: University of Nottingham, BSc course*

      :bdg:`Data extraction` :bdg:`Python`
  
  .. grid-item-card:: Creating experiments for rodent learning.
    :link: https://drive.google.com/drive/folders/15CMuKKz7fgNBhbL9GanTL5jgxW_gnUad?usp=sharing
      
      *Presented at: University College London, November 15th 2023*

      :bdg:`Data extraction` :bdg:`Python`
  
  .. grid-item-card:: Getting started with PsychoPy Builder.
    :link: https://drive.google.com/drive/folders/179Pevq4j46rucwIhKPFodwOksvoOFDSp?usp=sharing
      
      :bdg:`PsychoPy Builder` :bdg:`Presenting stimuli` :bdg:`Gathering keyboard responses` :bdg:`Setting up trial lists`
  
  .. grid-item-card:: Creating complex designs in PsychoPy.
    :link: https://drive.google.com/drive/folders/17Bumxj_6k1kShOr2aanQW0UXzwj_rA_U?usp=sharing
      
      :bdg:`PsychoPy Builder` :bdg:`Counterbalancing` :bdg:`Adaptive procedures` :bdg:`Staircases` :bdg:`Branched designs`
  
  .. grid-item-card:: Running experiments online with Pavlovia.
    :link: https://drive.google.com/drive/folders/17F0tiYo-tD1mAOjSjjO4xB0O-N-YitAn?usp=sharing
      
      :bdg:`Pavlovia` :bdg:`Daisy chaining with recruitment platforms` :bdg:`Surveys and Questionnaires with Pavlovia Surveys` :bdg:`Counterbalancing online` :bdg:`Multisessrion testing`
  
  .. grid-item-card:: Coding an experiment in Python.
    :link: https://drive.google.com/drive/folders/17KfU3r8rVH-iiScOVl3dVZW3LGyLe8fs?usp=sharing
      
      :bdg:`Python code` :bdg:`PsychoPy library`
  
  .. grid-item-card:: Communicating with external hardware.
    :link: https://drive.google.com/drive/folders/17ZMhd1Bbzdk3R4plc0kuYLrnlS6Yfklc?usp=sharing
      
      :bdg:`EEG` :bdg:`Eyetracking` :bdg:`fMRI` :bdg:`Serial and parallel ports`
...
.. card-carousel:: 2
    ...
    .. card:: **Flavia Hendler**, Haifa University 
    ...
    .. card:: **Shiyu Li**, Université de Montréal
    ...
    .. card:: **Alice Rees**, Lancaster University
