...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lpzjwp/OneDrive - The University of Nottingham/workshops/examples2019/builder/dynamic stimuli/gradualReveal/gradualReveal_lastrun.py',
