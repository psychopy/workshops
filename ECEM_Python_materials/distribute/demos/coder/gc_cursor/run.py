...
class ExperimentRuntime(ioHubExperimentRuntime):
    ...
    def createDataStoreConditionsTable(self,trials):
        """
        This function allow the use of psychopy TrialHandler's with
        the ioDataStore.

        TODO: Integrate into iohub.client proper.
        TODO: Base str fiel lengths on max str length found in trial data.
        """
        ...
        self.hub.initializeConditionVariableTable(ConditionVariableDescription)
